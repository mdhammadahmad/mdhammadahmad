...
<p align ="center">
  <i>I am Mohammad Hammd Ahmad</i>
  <br>
  <i>Deeply interested in Artificial Intelligence.</i>
  <br>
...
| Area | Skills |
|------|--------|
| 👨‍💻 Programming | Python, SQL, FastAPI, OOPs, DSA |
| 📐 Mathematics | Statistics, Probability, Linear Algebra, Hypothesis Testing |
| 🤖 Machine Learning | Scikit-Learn, Clustering, Pandas, NumPy, MLflow |
| 🧬 Deep Learning & NLP | PyTorch, TensorFlow, OpenCV, YOLO, CNN, RNN, LSTM, SpaCy, NLTK, Autoencoders |
| 🔮 Generative AI & LLMs | LangChain, LangGraph, RAG, Fine-tuning (LoRA/QLoRA), Prompt Engineering, Agentic AI, MCP, CLIP, BERT, Llama, OpenAI, DeepSeek, Diffusion Models, Sentence Transformers |
| ☁️ Cloud & DevOps | Azure, Docker, Git |
| 🗄️ Databases & Vector Stores | SQL, FAISS, ChromaDB, Pinecone |
| 📊 Analytics & Visualization | Power BI, Streamlit, Plotly |
</table>
...
<!--
**mdhammadahmad/mdhammadahmad** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
